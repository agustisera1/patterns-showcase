...
Proble de negocio: Cuando un pago se completa con éxito, deben ocurrir tres cosas: enviar un email al usuario, actualizar el dashboard de analíticas y notificar al sistema de impuestos.
